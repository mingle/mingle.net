...
HelpLibraryManagerLauncher.exe /product "VS" /version "100" /locale en-us /uninstall /silent /vendor "ThoughtWorks Studios" /mediaBookList "ThoughtWorks Studios API for .NET" /productName "ThoughtWorks Studios API for .NET"
