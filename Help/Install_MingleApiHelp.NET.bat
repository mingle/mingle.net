...
HelpLibraryManagerLauncher.exe /product "VS" /version "100" /locale en-us /uninstall /silent /vendor "ThoughtWorks Studios" /mediaBookList "Mingle API for .NET" /productName "Mingle API for .NET" > NUL
...
COPY /Y "MingleApiHelp.NET.msha" HelpContentSetup.msha
