...
set PATH=vendor\bundle\ironruby\1.8\bin;tools\ironruby\bin;C:\Program Files (x86)\Microsoft Visual Studio 10.0\Common7\IDE;C:\Windows\Microsoft.NET\Framework\v4.0.30319\;%PATH%
